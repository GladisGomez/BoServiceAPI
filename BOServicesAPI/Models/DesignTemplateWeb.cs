...
{
    public partial class DesignTemplateWeb
    {
        ...
        public int? DesignTemplateWebControlCompanies { get; set; }

        public virtual ControlCompanies DesignTemplateWebControlCompaniesNavigation { get; set; }
    }
}
