...
{
    public partial class MalfunctionAntennas
    {
        ...
        public virtual Antennas MalfunctionAntennaAntennaNavigation { get; set; }
        public virtual MalfunctionReports MalfunctionReportMalfunctionAntennaNavigation { get; set; }
    }
}
